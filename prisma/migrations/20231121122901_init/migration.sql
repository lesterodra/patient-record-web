...
CREATE TABLE `patient_records` (
    ...
    `refractionOd` VARCHAR(191) NULL,
    `refractionOdNegative` VARCHAR(191) NULL,
    `refractionOdX` VARCHAR(191) NULL,
    `refractionOs` VARCHAR(191) NULL,
    `refractionOsNegative` VARCHAR(191) NULL,
    `refractionOsX` VARCHAR(191) NULL,
    `refractionAdd` VARCHAR(191) NULL,
    `refractionPd` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NULL,
